  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden selection:bg-primary/20 bg-[#f8fafc] dark:bg-[#020617] aisa-scalable-text">
      ...
      <div className="relative w-full max-w-5xl flex flex-col items-center p-4">
        ...
        <div className="w-full flex justify-center mb-3 sm:mb-4 shrink-0 z-[60]">
          <img
            src={logo}
            alt="AISA™ Logo"
            className="w-[60px] sm:w-[80px] h-auto object-contain brightness-110 drop-shadow-2xl"
          />
        </div>
        ...
        >
          {/* Main Glass Card */}
          <div className="relative overflow-hidden bg-white/10 dark:bg-white/[0.04] backdrop-blur-[64px] border border-white/60 dark:border-white/10 p-5 sm:p-6 rounded-[2rem] sm:rounded-[3rem] shadow-[0_32px_120px_-20px_rgba(0,0,0,0.12)] text-center ring-1 ring-white/30 transition-all hover:bg-white/15 dark:hover:bg-white/[0.06] group/card">
            ...
            <div className="text-center mb-4 sm:mb-6 relative">
              <h2 className="text-xl sm:text-2xl font-black text-slate-800 dark:text-white mb-1 tracking-tighter uppercase">{t('createAccount')}</h2>
              <p className="text-slate-400 dark:text-slate-500 text-[8px] font-black uppercase tracking-[0.3em]">{t('joinAISA')}</p>
            </div>
            ...
            <AnimatePresence mode="wait">
              {(error || passwordError) && (
                <motion.div
                  ...
                  className="mb-4 p-2 rounded-xl bg-red-500/10 border border-red-500/20 text-red-600 dark:text-red-400 text-[8px] font-black uppercase tracking-widest flex items-center gap-2 justify-center backdrop-blur-md"
                >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="relative group">
                <div className="absolute inset-0 bg-white/30 dark:bg-slate-900/40 rounded-xl blur-sm transition-all group-focus-within:bg-white/50 dark:group-focus-within:bg-slate-900/60" />
                ...
                <input
                  ...
                  className="relative w-full bg-white/20 dark:bg-slate-800/20 border border-white/30 dark:border-white/5 rounded-xl py-2.5 pl-12 pr-4 text-slate-700 dark:text-white placeholder-slate-400/70 focus:outline-none focus:ring-1 focus:ring-white/50 dark:focus:ring-white/10 transition-all font-medium text-sm sm:text-base backdrop-blur-md"
                  required
                />
              </div>
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="relative w-full bg-white/20 dark:bg-slate-800/20 border border-white/30 dark:border-white/5 rounded-xl py-2.5 pl-12 pr-12 text-slate-700 dark:text-white placeholder-slate-400/70 focus:outline-none focus:ring-1 focus:ring-white/50 dark:focus:ring-white/10 transition-all font-medium tracking-[0.4em] text-sm sm:text-base backdrop-blur-md"
                  required
                />
                <button
                  type="button"
              ...
              <motion.button
                ...
                className={`w-full py-3 rounded-xl font-bold text-sm sm:text-base text-white shadow-xl transition-all duration-300 flex items-center justify-center gap-2 mt-1 ${agreedToTerms
            ...
            <div className="flex items-center gap-3 my-3">
              ...
              <span className="text-[8px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest px-2">Secure Social Signup</span>
              <div className="flex-1 h-px bg-white/20 dark:bg-slate-700/50" />
            </div>
            ...
            <div className={`grid grid-cols-2 gap-3 ${!agreedToTerms ? 'opacity-50 pointer-events-none' : ''}`}>
              ...
              <motion.button
                ...
                className="group relative flex flex-col items-center justify-center p-2 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm transition-all hover:shadow-md"
              >
                {googleLoading ? (
                  <div className="w-4 h-4 border-2 border-slate-300 border-t-primary rounded-full animate-spin" />
                ) : (
                  <>
                    <svg className="w-5 h-5 mb-0.5" viewBox="0 0 24 24">
                      <path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.32v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.1z" />
                      <path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" />
                      <path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" />
                      <path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" />
                    </svg>
                    <span className="text-[9px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-tighter">Google</span>
                  </>
                )}
              </motion.button>
              ...
              >
                ...
                <svg className="w-5 h-5 mb-0.5 fill-current text-black dark:text-white" viewBox="0 0 170 170">
                ...
                <span className="text-[9px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-tighter">Apple ID</span>
              </motion.button>
            </div>



            <div className="mt-4 pt-4 border-t border-white/10 dark:border-slate-800/50 text-center text-xs font-bold text-slate-400 tracking-wide uppercase relative">
